  ...
  const faqSchema = {
    ...
    'mainEntity': [
      ...
      },
      {
        ...
        'acceptedAnswer': {
          '@type': 'Answer',
          'text': 'المجموع الكلي لدرجات الثانوية العامة المصرية هو 410 درجات موزعة على المواد الأساسية للشعبتين العلمية والأدبية.'
        }
      },
      {
        '@type': 'Question',
    ...
    <div style={{ paddingTop: 10 }}>
      ...
      <div className="card" style={{ marginTop: 24 }}>
        ...
        <ol style={{ paddingRight: 20, margin: 0, color: '#4b5563', fontSize: '0.9rem', lineHeight: '1.8' }}>
          ...
          <li>تأكد من مراجعة المجموع الكلي (من 410) والدرجات في كل مادة دراسية.</li>
        </ol>
      </div>
      ...
      >
        ...
        <p style={{ margin: '4px 0 0 0' }}>
          هذا الموقع خدمة مستقيلة لتسهيل وصول الطلاب لنتائجهم، وتعتمد كافة البيانات المعروضة على القوائم والإعلانات الصادرة عن وزارة التربية والتعليم والتعليم الفني المصرية. تعتبر المستندات الورقية الرسمية المسلمة بالمدارس هي المرجع الوحيد المعتمد.
        </p>
      </div>
    </div>
  );
